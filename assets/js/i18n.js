...
const translations = {
  ...
  pp_encryption: { en: 'Challenge: sensitive data needed protection from unauthorized access. Solution: I built an app implementing secure encryption/decryption for safe data handling.', sw: 'Changamoto: data nyeti ilihitaji ulinzi dhidi ya ufikiaji usioidhinishwa. Ufumbuzi: Nilijenga app inayotekeleza usimbaji/kufungua data kwa usalama.' },
  pp_bluetooth: { en: 'Challenge: Enabling communication without internet access in low-connectivity areas. Solution: I developed a chat app using Bluetooth for offline peer-to-peer messaging. And this was my FYP 2025', sw: 'Changamoto: Kuwezesha mawasiliano pasipo mtandao wa intaneti maeneo yenye mtandao hafifu. Ufumbuzi: Nilitengeneza app ya chat inayotumia Bluetooth kwa ujumbe wa moja kwa moja bila intaneti. Na hii ndo ilikuwa project yangu ya mwaka wa mwisho 2025' },
  ...
  pp_logo2: { en: 'Brief: I designed a distinctive logo reflecting the client\'s brand personality.', sw: 'Lengo: Nilibuni logo ya kipekee inayoakisi tabia ya brand ya mteja.' },
  pp_logo4: { en: 'Brief: created a clean, versatile logo usable across print and digital media.', sw: 'Lengo: Nilitengeneza logo safi inayoweza kutumika kwenye machapisho na midia ya kidijitali.' },
  ...
  pp_social2: { en: 'Brief: Created a striking post board design aligned with the client\'s campaign goals.', sw: 'Lengo: Nilitengeneza bango la mitandao ya kijamii linalovutia kulingana na malengo ya kampeni ya mteja.' },
